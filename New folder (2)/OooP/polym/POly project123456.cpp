...
class Teacher:public login_portals::Logins,Registered_Students::Registered_Student,Registration::Registrar,CGpa::CGPA, Road_Maps_And_Courses_Datails::Road_Map,private Loged_Out
{
	private:
...
namespace Students{
class student:private Registration::Registrar,private Loged_Out,login_portals::Logins//,public Logins
...
namespace login_portals
{
class Logins:private Teacher//,private student
{
private:
	int id,pass;
	int choice;
