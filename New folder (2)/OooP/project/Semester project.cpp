...
class Teacher:private Registered_Students::Registered_Student,private Registration::Registrar,private CGpa::CGPA, private Road_Maps_And_Courses_Datails::Road_Map,private Loged_Out//,private login
{
	private:
...
namespace Students{
class student:Registration::Registrar,private Loged_Out//public login
...
class login:private Teacher,private Students::student
{
private:
	int id,pass;
	int choice;
