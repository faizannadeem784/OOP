		...
		public:
			...
			void search_by_name()
			{
			 ...
			 student_info_5 = 5;
				...
				cout<<"Press a number between 1-5 to find a student record"<<endl;
				cin>>n;
				if(fout.is_open())
				{
					if(n==1)
					{
						cout<<"\nRecord Found\nFor Student # 1 :)"<<student_info_1;
					}
					else if(n==2)
					{
						cout<<"\nRecord Found\nFor Student # 2 :)"<<student_info_2;
					}
				    else if(n==3)
					{
						cout<<"\nRecord Found\nFor Student # 3 :)"<<student_info_3;
					}
					else if(n==4)
					{
						cout<<"\nRecord Found\nFor Student # 4 :)"<<student_info_4;
					}
					else if(n==5)
					{
						cout<<"\nRecord Found\nFor Student # 5 :)"<<student_info_5;
					}
					else
					{
