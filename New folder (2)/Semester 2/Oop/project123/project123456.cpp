...
class Teacher:Registered_Students::Registered_Student,Registration::Registrar,CGpa::CGPA, Road_Maps_And_Courses_Datails::Road_Map,private Loged_Out
{
	private:
...
namespace Students{
class student:Registration::Registrar,private Loged_Out
