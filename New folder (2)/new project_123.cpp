...
class Road_Map:public access_map
{
private:
...
class Teacher:Registered_Students::Registered_Student,Registration::Registrar,public CGPA, Road_Maps_And_Courses_Datails::Road_Map,public Loged_Out,public access_map
{
	private:
	Teacher* t;
	CGPA *C;
...
class student : public Loged_Out , Registration::Registrar,public access_map
{
private:
	int 	choice,go_back,department,Smester_No,SaveView;
	float	Last_CGPA;
